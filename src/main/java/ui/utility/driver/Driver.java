...
import ui.utility.driver.driver_builder.RemoteDriverBuilder;
...
public final class Driver {
    ...
    private static final ThreadLocal<BuilderCatalog> DRIVER_TYPE = new ThreadLocal<>();
    ...
    public void setDriver() {
        ...
        //Set the BuilderCatalog for this thread to the browser we just got from the properties file.
        DRIVER_TYPE.set(BuilderCatalog.parseString(browser));
    ...
    public void setDriver(String browser) {
        ...
        //Set the BuilderCatalog for this thread to the browser passed/found in properties.
        DRIVER_TYPE.set(BuilderCatalog.parseString(browser));
